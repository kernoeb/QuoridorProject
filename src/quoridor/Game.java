...
public class Game {
	...
	public Game(Mode mode, String namePlayer1, String namePlayer2) {
		...
		if (mode == Mode.HH) {
			this.player1 = new HumanPlayer(this, namePlayer1, this.board, 8, 4);//this.board.pawnCoord(0), this.board.pawnCoord(4));
			this.player2 = new HumanPlayer(this, namePlayer2, this.board, 0, 4);//this.board.pawnCoord(8), this.board.pawnCoord(4));
		}

		else if (mode == Mode.HA) {
			this.player1 = new HumanPlayer(this, namePlayer1, this.board, 8, 4);//this.board.pawnCoord(0), this.board.pawnCoord(4));
			this.player2 = new AutoPlayer(this, namePlayer2, this.board, 0, 4); //this.board.pawnCoord(8), this.board.pawnCoord(4));
		}
